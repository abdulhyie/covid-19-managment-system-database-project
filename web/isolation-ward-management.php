...
<head>
    ...
    <title>Isolation Ward Management</title>
        ...
        if($_SESSION["username"] == "admin" OR $_SESSION["username"] == "doctor")
        {
            echo '
                <section class="options">
                    <h1>
                        Isolation Wards Management
                    </h1>
                    <section class="buttons">
                        <ul>
                            <li><a href="add-iso.html" class="add">Add Record</a></li>
                            <li><a href="update-iso.html" class="update">Update Record</a></li>
                            <li><a href="search-iso.html" class="search">Search Record</a></li>
                            <li><a href="delete-iso.html" class="delete">Delete Record</a></li>
                        </ul>
                    </section>
                </section>';
        }
